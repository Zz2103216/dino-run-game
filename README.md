...
# 🔫 像素战警 · 跑酷射击 — HTML5 横版射击游戏

> 像素风横版跑酷射击游戏。控制男性战警角色躲避障碍、射击敌人，内置 BOSS 战、弹幕系统、弹药/护盾机制。单人经典模式 + 双人实时联机对战，浏览器即开即玩。
...
- 👤 **原创像素战警角色** — 男性角色，军绿装甲+深蓝军裤，细节丰富的像素绘制
- 🏃 **经典跑酷** — 跳跃、匍匐躲避障碍物，手感流畅
- 🔫 **射击系统** — 鼠标瞄准，点击/键盘开火，枪口火焰特效
...
```
dino-run-game/
├── index.html          # 游戏主文件（~1300 行，全部前端逻辑+Canvas绘制）
...
| 层 | 技术 |
|-----|------|
| 前端 | HTML5 Canvas, 原生 JavaScript（零框架依赖） |
| 联机 | Socket.IO v4 |
| 服务端 | Node.js + Express |
